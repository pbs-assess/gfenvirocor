...
Subsets of these variables was selected based on an initial exploration of correlations with recruitment deviations (Figure \@ref(fig:ev-indices)). 
...
knitr::include_graphics(here::here(paste0("../gfcondition/stock-specific/",spp,"/figs/spawn-O2.png")))
```
...
knitr::include_graphics(here::here(paste0("../gfcondition/stock-specific/",spp,"/figs/sp-O2.png")))
```
...
knitr::include_graphics(here::here(paste0("../gfcondition/stock-specific/",spp,"/figs/env_corplot.png")))
```
...
knitr::include_graphics(here::here(paste0("../gfcondition/stock-specific/",spp,"/figs/rdev-enviro-corr-timeseries-Final11-lm-31.png")))
```
...
knitr::include_graphics(here::here(paste0("../gfcondition/stock-specific/",spp,"/figs/rdev-enviro-corr-timeseries-Final11-lm-quadratic-31.png")))
```
