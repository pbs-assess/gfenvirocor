...
pelagic_months <- "February through April"
end_pelagic_month <- "April"
juv_months <- "April through December"
condition_months <- "April through June"

rdev_years <- c(1996, 2019)
cond_years <- c(2003, 2024)
  
# stock assessment model name
scenario <- "base"
cond_model_date <- "2025-07"
  
full_rdev_var_count <- 13
short_rdev_var_count <- 13
  
full_cond_var_count <- 3
short_cond_var_count <- 3
```
...
knitr::include_graphics(here::here(paste0("stock-specific/",spp,"/figs/rdev-enviro-corr-coef-violins-start-",rdev_years[1],"-",scenario,"-100-draws-brms-",full_rdev_var_count,".png")))
```
...
knitr::include_graphics(here::here(paste0("stock-specific/",spp,"/figs/rdev-enviro-corr-timeseries-start-",rdev_years[1],"-",scenario,"-100-draws-",full_rdev_var_count,".png")))
```


<!-- Only include if testing without outlier -->
...
# knitr::include_graphics(here::here(paste0("stock-specific/",spp,"/figs/rdev-enviro-corr-timeseries-",scenario,"-start-",rdev_years[1],"100-draws-",full_rdev_var_count,"-no-outlier.png")))
```
...
knitr::include_graphics(here::here(paste0("stock-specific/",spp,"/figs/rdev-condition-corr-timeseries-",scenario,"-start-",max(rdev_years[1],cond_years[1]),"-100-draws-bmrs-poly-lag.png")))
```
...
<!-- < fig 12 > -->
<!-- Could include for relevant variables at end of caption: -->
...
# knitr::include_graphics(here::here(paste0("stock-specific/",spp,"/figs/rdev-enviro-corr-coef-violins-start-",rdev_years[1],"-",scenario,"-100-draws-brms-", short_rdev_var_count ,"-just-poly-short.png")))
```
...
# knitr::include_graphics(here::here(paste0("stock-specific/",spp,"/figs/rdev-enviro-corr-timeseries-",scenario,"-start-",rdev_years[1],"-100-draws-", short_rdev_var_count ,"-short.png")))
```
